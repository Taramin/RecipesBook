...
CREATE TABLE recipies(
  ...
  CONSTRAINT recIngList FOREIGN KEY (ingredients_list_id) REFERENCES ingredients_lists(id) ON DELETE CASCADE ON UPDATE CASCADE
...
CREATE TABLE ingredients(
  ...
  CONSTRAINT ingLIng FOREIGN KEY (ingredients_list_id) REFERENCES ingredients_lists (id) ON DELETE CASCADE ON UPDATE CASCADE,
...
--------------------------------------------
  ...
  INSERT INTO
ingredients(id, name, weight, calories_number, ingredients_list_id, cooking_way_id, product_id)
VALUES
('1','boiled milk','1000', '45','1', '1', '1');


  INSERT INTO
ingredients(id, name, weight, calories_number, ingredients_list_id, cooking_way_id, product_id)
VALUES
('2','fried pork','600', '290','2', '2', '2');


  INSERT INTO
ingredients(id, name, weight, calories_number, ingredients_list_id, cooking_way_id, product_id)
VALUES
('3','cut tomato','300', '20', '3', '5', '5');


  INSERT INTO
ingredients(id, name, weight, calories_number, ingredients_list_id, cooking_way_id, product_id)
VALUES
('4','cut cheese','300', '280', '3', '5', '2');
...
-------------------------------
INSERT INTO
  recipies (id, name, description, author_id, ingredients_list_id)
VALUES
